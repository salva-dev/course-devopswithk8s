...
```console
$ docker build -t salvahappydev/project-v01:node-latest .
$ docker login
$ docker push salvahappydev/project.v01:node-latest
$ kubectl create deployment log-output --image=salvahappydev/project-v01:node-latest 
